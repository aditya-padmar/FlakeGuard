...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center justify-center p-2 rounded-lg text-neutral-400 hover:text-white transition-colors hover:bg-white/5 active:scale-95 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-cyan-400",
        className
      )}
      {...props}
    >
      {isDark ? <Sun className="w-4 h-4 text-neutral-300 hover:text-white" /> : <Moon className="w-4 h-4 text-neutral-700 hover:text-black" />}
